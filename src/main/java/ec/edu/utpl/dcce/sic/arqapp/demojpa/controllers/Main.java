...
import ec.edu.utpl.dcce.sic.arqapp.demojpa.model.ProyectoProgramacion;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //ProyectoProgramacion p = new ProyectoProgramacion();
        ...
        //p.setProyectoPorgramcion("Protecto AA");
        //p.setUrlGit("https://git.taw.utpl.edu.ec/jorgaf/demojpamaven");
        ...
        System.out.println("Estos son los entregables del proyecto: "+p.getEntregables());
